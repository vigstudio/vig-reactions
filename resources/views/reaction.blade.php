...
<div class="dw-reactions-3"
    ...
    <div class="dw-reactions-box-3">
        <div style="height: 100px; background-color:#ecf0f1">
            <div class="dw-reactions-percent" id="vig-percent-like"></div>
            <div class="dw-reactions-count-3 badge badge-danger"
...
@php
    ...
    Theme::asset()
             ->add('vig-reaction', 'vendor/core/plugins/vig-reactions/vig-reaction.min.v1.css');
    Theme::asset()
            ->container('footer')
            ->add('vig-reaction', 'vendor/core/plugins/vig-reactions/vig-reaction.min.v1.js');
@endphp
